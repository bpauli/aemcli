...
def process_files(content_xml_files, properties_to_remove, dry_run):
    """
    Process all content XML files and return summary statistics.
...
def print_summary(modified_count, total_count, dry_run):
    """
...
def content_cleanup(path, dry_run, use_default, properties):
    ...
    modified_count, total_count = process_files(
